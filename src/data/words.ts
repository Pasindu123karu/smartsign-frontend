...
export const wordsData: WordData[] = [
  ...
  { word: "hungry", category: "Daily", emoji: "🍽️", description: "Feeling like you need food!", color: "from-red-400 to-orange-400", difficulty: "easy", image: "/assets/signs/word/hungry.jpg" },
  ...
  { word: "more", category: "Daily", emoji: "➕", description: "Ask for extra!", color: "from-cyan-400 to-blue-400", difficulty: "easy", image: "/assets/signs/word/more.jpg" },
  { word: "no", category: "Basic", emoji: "❌", description: "Disagree or say something is wrong!", color: "from-red-400 to-pink-400", difficulty: "easy", image: "/assets/signs/word/no.jpg" },
