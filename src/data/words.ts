...
export const wordsData: WordData[] = [
  ...
  { word: "no", category: "Basic", emoji: "❌", description: "Disagree or say something is wrong!", color: "from-red-400 to-pink-400", difficulty: "easy", image: "/assets/signs/wordsno.jpg" },
